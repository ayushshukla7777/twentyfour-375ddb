...
const PHOTOS = {
  ...
  p02: "Mirror selfie in the office corridor, lanyard on, me photobombing behind you.",
  p03: "Sitting by the shrine on festival morning, marigolds and diyas everywhere.",
  p04: "This one. The one I keep coming back to.",
  p05: "Both of us with paper glasses on, pretending we're serious people.",
  p06: "That smile, first thing in the morning, before either of us was awake properly.",
  p07: "Holding the aarti thali, looking like the festival was arranged just for you.",
  p08: "Lying down somewhere past midnight, camera at a terrible angle, perfect anyway.",
  p09: "Double thumbs up. There is no version of you I love more than this one.",
  p10: "White kurti, mirror, and that look you do when you know you look nice.",
  p11: "Split screen: me laughing like an idiot, you grinning back. Our whole relationship.",
  p12: "You laughed so hard this photo went blurry. It's still my favourite kind of photo.",
  p13: "Adjusting your necklace mid-sentence, not knowing I was staring.",
  p14: "Coral kurta, office mirror, ID card on — the working woman.",
  p15: "The big one. The smile that gets me every single time.",
  p16: "Me holding a notebook at the camera: “Tumhe pyaar karta hoon.” I meant it then, I mean it now.",
  p17: "Hand on your head, laughing at something I said. I'd say it again just for this.",
  p18: "Teal shirt, white background, so composed. This is the one they got to keep.",
  p19: "In the garden, sunglasses on, fountain behind you, completely in your element.",
  p20: "2:49am. Your face glowing in the dark, still on the call, refusing to hang up.",
  p21: "Doing aarti beside Maa. This is the you I love most — the one at home.",
  p22: "Asleep under the orange blanket with the call still running. I watched you sleep.",
  p23: "Hand on your cheek, that soft smile. I remember exactly what we were talking about.",
  p24: "ICON t-shirt, standing in your room, mid-story about your day.",
  p25: "The whole family dressed up, you in the middle of it. This is your world. I love your world.",
  p26: "Standing in front of the “my day” wall. You had no idea how true that was.",
  p27: "Lying in pink, looking right at me, saying nothing. Didn't need to.",
  p28: "ICON t-shirt again, waving at the camera like I was far away. I was.",
  p29: "Olive top, that warm smile, the one you save for when it's just us.",
  p30: "Red dupatta, sunglasses, sun on your face. You belong in this weather.",
  p31: "My side of the call. White tee, terrible lighting, watching you.",
  p32: "11:53pm, hand on your head, fighting sleep, still refusing to go.",
  p33: "The pout. You know exactly what you're doing with that pout.",
  p34: "Blue striped polo, office mirror, on your way in.",
  p35: "White top, bangles, by the old wooden door. You look like a film still here.",
  p36: "Office lift lobby again. I have about forty of these and I love all of them.",
  p37: "“Na Gussa. No Baby!! Apne Golu ko maaf kardo.” I will write you a hundred of these.",
  p38: "In front of the Taj Mahal. The monument looks pretty. You look better.",
  p40: "Another 2:49am. Same sleepy smile. Same refusal to hang up.",
  p41: "Beige shirt, lanyard, phone in hand, mid-day at work. Sending me something, probably.",
  p42: "1:47am. Eyes closed, call still on. This is what loving you looks like.",
  p43: "Floral dress, arches behind you, open sky. You, being happy.",
  p44: "Train mirror selfie with the berths behind you. Going somewhere. I hope it was worth it.",
  p45: "On the train with everyone, holding the blue basket of snacks. Joyful, surrounded, home.",
};
...
const VIDEO_POSTERS = { v1: "p19", v2: "p30", v3: "p43", v4: "p21" };
